...
function tick() {
	...
	enemies.each(function() {
		...
		playerLeft = getLeft($('#player'));
		thisTop = getTop($(this));
		playerTop = getTop($('#player'));
...
$(document).ready(function() {
	...
	$('body').keypress(function(e) {
		if ($('.report').length == 0) {
			...
			$('body').html('<p id="score">0</p><p id="high_score">high score: ' + high_score + '</p><div id="player"></div>');
			end = false;
			score = 0;
			tick();
		}
